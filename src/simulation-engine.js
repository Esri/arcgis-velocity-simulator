...
class SimulationEngine extends EventEmitter {
  ...
  async connect() {
	...
	await this.transport.connect({
	  ...
	  httpFormat: this.options.httpFormat,
	  httpPath: this.options.httpPath,
	  httpTls: this.options.httpTls,
	  httpTlsCaPath: this.options.httpTlsCaPath,
	  httpTlsCertPath: this.options.httpTlsCertPath,
	  httpTlsKeyPath: this.options.httpTlsKeyPath,
	  httpAllowUnverifiedTls: this.options.httpAllowUnverifiedTls,
	  wsFormat: this.options.wsFormat,
	  wsPath: this.options.wsPath,
	  wsTls: this.options.wsTls,
	  wsTlsCaPath: this.options.wsTlsCaPath,
	  wsTlsCertPath: this.options.wsTlsCertPath,
	  wsTlsKeyPath: this.options.wsTlsKeyPath,
	  wsAllowUnverifiedTls: this.options.wsAllowUnverifiedTls,
	  wsSubscriptionMsg: this.options.wsSubscriptionMsg,
	  wsIgnoreFirstMsg: this.options.wsIgnoreFirstMsg,
	  wsHeaders: this.options.wsHeaders,
